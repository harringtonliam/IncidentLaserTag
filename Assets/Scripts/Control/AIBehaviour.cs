...
namespace RPG.Control
{
    public class AIBehaviour : MonoBehaviour
    {
        ...
        {
            aIControler.SetPatrolPath(behaviourDescription.patrolPath, true, behaviourDescription.doPatrolPathOnce);
            ...
            aIControler.SetTransformDestination(behaviourDescription.transformDestination);
        }

        private void ApplyNoBehaviour()
        {
            aIControler.SetPatrolPath(null, false);
            aIControler.SetTransformDestination(null);
        }
